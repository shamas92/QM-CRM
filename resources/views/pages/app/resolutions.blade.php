<x-base-layout :scrollspy="false">
    ...
    <x-slot:pageTitle>
        ...
        <x-slot:headerFiles>
            ...
            @vite(['resources/scss/light/assets/apps/resolutions.scss'])

            @vite(['resources/scss/dark/assets/components/modal.scss'])
            @vite(['resources/scss/dark/assets/apps/resolutions.scss'])
            <!--  END CUSTOM STYLE FILE  -->
            </x-slot>
            <!-- END GLOBAL MANDATORY STYLES -->

            <div class="action-btn layout-top-spacing mb-5">
                <button id="add-list" class="btn btn-secondary">Add Process</button>
            </div>
                ...
                <div class="col-lg-12 layout-spacing">
                    ...
                    <div class="task-list-section">
                        ...
                        <div data-section="s-approved" class="task-list-container" data-connect="sorting">
                            ...
                            <div class="connect-sorting">
                                <div class="task-container-header">
                                    <h6 class="s-heading" data-listTitle="{{$list['list_title']}}">{{$list['list_title']}}</h6>
                                    <div class="dropdown">
                                    ...
                                    <div data-draggable="true" class="card task-text-progress">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                ...
                                                <div class="">
                                                    <h4 class="" data-taskTitle="{{$list['task_title']}} ">{{$list['task_title']}}</h4>
                                                </div>
                                            ...
                                            <div class="task-body">
                                                ...
                                                <div class="task-content">
                                                    <p class="" data-taskText="{{$list['task_desc']}}">{{$list['task_desc']}}</p>
                                                </div>
                        ...
                        <div data-section="s-in-progress" class="task-list-container" data-connect="sorting">
                            <div class="connect-sorting">
                                <div class="task-container-header">
                                    <h6 class="s-heading" data-listTitle="Complete">In Progress</h6>
                                    <div class="dropdown">
                                ...
                                <div class="connect-sorting-content" data-sortable="true">
                                    <div data-draggable="true" class="card simple-title-task ui-sortable-handle">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                <div class="">
                                                    <h4 class="" data-tasktitle="Work on defect 1">Work on defect 1</h4>
                                                </div>
                                                <div class="">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 s-task-edit">
                                                        <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                    ...
                                    <div data-draggable="true" class="card task-text-progress">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                ...
                                                <div class="">
                                                    <h4 class="" data-taskTitle="Implement Solutions">Implement Solutions</h4>
                                                </div>
                                            ...
                                            <div class="task-body">
                                                ...
                                                <div class="task-content">
                                                    <p class="" data-taskText="Implement Older Defects Solutions on Production">Implement Older Defects Solutions on Production</p>
                        ...
                        <div data-section="s-new" class="task-list-container" data-connect="sorting">
                            <div class="connect-sorting">
                                <div class="task-container-header">
                                    <h6 class="s-heading" data-listTitle="In Progress">Complete</h6>
                                    <div class="dropdown">
                                ...
                                <div class="connect-sorting-content" data-sortable="true">
                                    ...
                                    <div data-draggable="true" class="card img-task">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                <div class="">
                                                    <h4 class="" data-taskTitle="Adapt New Business Model">Adapt New Business Model</h4>
                                                </div>
                                            </div>
                                    ...
                                    <div data-draggable="true" class="card simple-title-task">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                <div class="">
                                                    <h4 class="" data-taskTitle="Join Team Meeting">Join Team Meeting</h4>
                                                </div>
                                                <div class="">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 s-task-edit">
                                                        <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
            ...
            <x-slot:footerFiles>
                ...
                @vite(['resources/assets/js/apps/resolutions.js'])
                </x-slot>
