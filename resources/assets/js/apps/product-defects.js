...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelector('#addTaskModal').addEventListener('show.bs.modal', function (event) {
    ...
    if (button.dataset.mode === 'edit') {
      ...
      var defectId = button.dataset.id;
      var defectTitle = button.dataset.title;
      var defectDescription = button.dataset.description;
      var updateUrl = button.dataset.url;

      modal.querySelector('.add-title').style.display = 'none';
      modal.querySelector('.edit-title').style.display = 'block';
      modal.querySelector('#task').value = defectTitle;
      modal.querySelector('#taskdescription').value = defectDescription;
      modal.querySelector('form').action = updateUrl;
      modal.querySelector('#modal-submit-button').textContent = 'Update Defect';
    }
  });
});
